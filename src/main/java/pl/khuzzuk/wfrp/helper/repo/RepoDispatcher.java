...
import pl.khuzzuk.wfrp.helper.repo.crud.CharacterRepo;
import pl.khuzzuk.wfrp.helper.repo.crud.CurrencyRepo;
...
import pl.khuzzuk.wfrp.helper.repo.crud.LanguageRepo;
...
import pl.khuzzuk.wfrp.helper.repo.crud.NationRepo;
...
import pl.khuzzuk.wfrp.helper.repo.crud.SpellRepo;
import pl.khuzzuk.wfrp.helper.repo.crud.SpellSchoolRepo;
...
class RepoDispatcher implements InitializingBean {
    ...
    private final SpellSchoolRepo spellSchoolRepo;
    private final SpellRepo spellRepo;
    private final CharacterRepo characterRepo;
    private final EyeColorRepo eyeColorRepo;
    private final HairColorRepo hairColorRepo;
    private final PhysicalFeatureRepo physicalFeatureRepo;
    ...
    public void afterPropertiesSet() {
        ...
        repositories.put(SpellSchool.class, spellSchoolRepo);
        repositories.put(Spell.class, spellRepo);
        repositories.put(Character.class, characterRepo);
        repositories.put(EyeColor.class, eyeColorRepo);
        repositories.put(HairColor.class, hairColorRepo);
        repositories.put(PhysicalFeature.class, physicalFeatureRepo);
        repositories.put(Nation.class, nationRepo);
        repositories.put(Language.class, languageRepo);
        repositories.put(Currency.class, currencyRepo);
        repositories.put(Person.class, personRepo);
