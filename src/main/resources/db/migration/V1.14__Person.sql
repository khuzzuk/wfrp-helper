...
CREATE TABLE creature.person_skills_history (
    rev BIGINT, revtype SMALLINT, person_id BIGINT, skills_id BIGINT, PRIMARY KEY (person_id, skills_id, rev)
    );
...
CREATE TABLE creature.person_professions_history (
    rev BIGINT, revtype SMALLINT, person_id BIGINT, profession_id BIGINT, PRIMARY KEY (person_id, profession_id, rev)
    );
...
CREATE TABLE creature.person_spells_history (
    rev BIGINT, revtype SMALLINT, person_id BIGINT, spells_id BIGINT, PRIMARY KEY (person_id, spells_id, rev)
    );
